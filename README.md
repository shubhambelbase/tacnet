...
### **Decentralized Tactical Push-to-Talk (PTT) Transceiver**

[![Release](https://img.shields.io/github/v/release/shubhambelbase/tacnet?style=for-the-badge&color=00E676&label=OFFICIAL%20RELEASE)](https://github.com/shubhambelbase/tacnet/releases/latest)
...
- **Push-to-Talk (PTT)**: Zero-lag voice transmission with tactile haptic response and physical hardware button triggers.
- **Backlit Military LCD Ticker**: Central LCD dashboard with live animated text feed and smooth auto-scrolling ticker.
- **Acoustic Noise Control**: Built-in Squelch Noise Gate, Acoustic Echo Cancellation, and Noise Suppression.
...
1. Download **[app-release.apk](https://github.com/shubhambelbase/tacnet/releases/latest/download/app-release.apk)** from the official release page.
